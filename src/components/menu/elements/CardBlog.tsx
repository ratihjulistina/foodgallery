...
export async function CardBlog() {
  ...
  return (
    <div className="w-[87.4%] mx-auto ">
      <div className=" w-[100%] py-10 mx-auto  desktop:grid grid-cols-3 gap-5 ">
        {posts &&
            ...
            >
              <Link className=" " href={`article/${blog.fields.slug}`}>
                ...
                <div className=" h-[60%] flex flex-col justify-between m-auto">
                  ...
                  <div
                    className={`${poppins.variable} font-secondary font-normal text-gray-700 mb-3 `}
                  >
                    {" "}
